...
c( ) is a __function__ that combines various arguments or __elements__ to form a __vector__, a one-dimensional series of values. class( ) is also a function, which returns the class of the object in parentheses.

<br/>

#### Tip: Help with functions
You can access the help page for a function by using the ? mark. Try typing ?c into the console. ? will try to access the help page for a particular command, while ?? will search the help pages.
